module RubyJmeter
  class DSL
    def view_results_in_6_graph(params={}, &block)
      node = RubyJmeter::ViewResultsInResponseTimesDistributionGui.new(params)
      attach_node(node, &block)
    end
  end

  class ViewResultsInResponseTimesDistributionGui
    attr_accessor :doc
    include Helper
